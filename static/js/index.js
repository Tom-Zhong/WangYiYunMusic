// 张海瑞 - zhanghairui.com
var aMusicData=[
	{'thumbnail':'static/images/1.jpg', 'music':'static/music/1.m4a', 'title':'林肯公园 In The End', 'href':'1.html', 'singer':'林肯公园', 'song':'In The End'},
	{'thumbnail':'static/images/2.jpg', 'music':'static/music/2.m4a', 'title':'张靓颖 终于等到你', 'href':'2.html', 'singer':'张靓颖', 'song':'终于等到你'},
	{'thumbnail':'static/images/3.jpg', 'music':'static/music/3.m4a', 'title':'蔡健雅 Beautiful Love', 'href':'3.html', 'singer':'蔡健雅', 'song':'Beautiful Love'}
];
...
(function (){
	...
	function _modifiedSongInfo()
	{
		...
		var oRunBtn=$('#j-progressbtn');

		oNow.html('00:00');
		oCurrent.css('width', '0%');
		oRunBtn.css('position','absolute');
		oRunBtn.css('top',-6+'px');
